...
class HorseRepository
{
    ...
    public function getHorsesbyIdUser()
    {
        $idUser = $_SESSION['user']->getIdUser();

        $sql = "SELECT " . PREFIXE . "horse.id_horse, " . PREFIXE . "horse.name_horse, " . PREFIXE . "horse.birthdate_horse, " . PREFIXE . "horse.image_horse, " . PREFIXE . "horse.height_horse, " . PREFIXE . "horse.coat_horse, " . PREFIXE . "box.name_box, " . PREFIXE . "boarding.id_boarding, " . PREFIXE . "boarding.name_boarding
            FROM " . PREFIXE . "horse
            JOIN " . PREFIXE . "user ON " . PREFIXE . "horse.id_user = " . PREFIXE . "user.id_user
            JOIN " . PREFIXE . "box ON " . PREFIXE . "horse.id_box = " . PREFIXE . "box.id_box
            LEFT JOIN " . PREFIXE . "boarding ON " . PREFIXE . "horse.id_boarding = " . PREFIXE . "boarding.id_boarding
            WHERE  " . PREFIXE . "horse.id_user = :id_user
            ORDER BY " . PREFIXE . "horse.name_horse ASC";
