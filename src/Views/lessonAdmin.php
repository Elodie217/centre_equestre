            ...
            <div class=" relative overflow-hidden rounded-xl bg-white border-[#C0DF85] border-4 text-left shadow-xl sm:my-8 sm:w-full sm:max-w-lg p-6 ">
                ...
                <div class="divAddLesson">
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <div class="divAddLessonLevel flex flex-wrap">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="lessonUser flex flex-col h-16 overflow-auto"></div>
                    </div>
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class=" relative overflow-hidden rounded-xl bg-white border-[#C0DF85] border-4 text-left shadow-xl sm:my-8 sm:w-full sm:max-w-lg p-6 ">
                ...
                <div class="divViewLesson">
                    <h3 class="text-2xl text-center mb-8">Cours ...</h3>
                    <p class="italic">Le 5 janvier à 9h00</p>
                    <p class="mb-2 mt-6"><span class="font-bold">Participants : </span> 7/8</p>
