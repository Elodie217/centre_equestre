...
<section class="bg-[url('https://images.unsplash.com/photo-1589824493580-eacaf31c2a82?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] h-full bg-cover bg-center -mt-10">
    ...
    <h1 class="text-8xl text-center py-48 w-2/3 m-auto font-bold textShadow" style='font-family: "Amatic SC", sans-serif;'>Contact</h1>
...
<section class="md:flex justify-around my-10 flex-wrap sm:flex-nowrap ">
    ...
    <div class="w-fit max-w-[500px] mx-auto p-8 md:mx-4 bg-[#C0DF85] rounded-lg">
        ...
        <div class="flex sm:space-x-4">
            <input type="text" id="lastnameContact" class="indent-1 w-full border-b-2 border-gray-900 placeholder-black bg-[#C0DF85] m-4" placeholder="Nom*">
            <input type="text" id="firstnameContact" class="indent-1 w-full border-b-2 border-gray-900 placeholder-black bg-[#C0DF85] m-4" placeholder="Prénom*">
        </div>

        <input type="email" id="emailContact" class="indent-1 w-full border-b-2 border-gray-900 placeholder-black bg-[#C0DF85] m-4" placeholder="Email*">
        <textarea name="message" id="messageContact" class="indent-1 border-b-2 border-gray-900 placeholder-black bg-[#C0DF85] m-4 w-full h-40" placeholder="Votre message* ..."></textarea>
