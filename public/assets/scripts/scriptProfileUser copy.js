...
function getUser() {
  fetch(HOME_URL + "user/profile/userbyid")
    .then((res) => res.text())
    .then((data) => {
      displayProfileUser(JSON.parse(data));
    });
}

function displayProfileUser(user) {
...
// Edit User
function openEditProfileUser(User) {
  console.log(User);
...
function EditProfileUserVerification(idUser) {
...
function EditProfileUser(
  ...
  fetch(HOME_URL + "user/profile/edit", params)
    .then((res) => res.text())
    .then((data) => reponseEditProfileUser(JSON.parse(data)));
}

function reponseEditProfileUser(data) {
